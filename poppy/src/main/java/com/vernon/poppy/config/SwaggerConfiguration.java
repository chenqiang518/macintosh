...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("macintosh系统")
                // 描述
                .description("macintosh接口文档")
                // 创建人信息
                .contact(new Contact("leiming", "", "cq18390522307@163.com"))
                // 项目API版本号
                .version("1.0.0")
                .build();
    }
...
//                .apis(RequestHandlerSelectors.any())
                .apis(RequestHandlerSelectors.basePackage("com.vernon.poppy"))
